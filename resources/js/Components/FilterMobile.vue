...
const handleSubmit = () => {
    if (selectedProduct.value) {
        ...
        if (product) {
            ...
            router.visit(route("product-details", {
...
<template>
  <div
            class="max-w-7xl mx-auto bg-blue-100 p-5 rounded-md"
        >
            <div class="flex justify-center">
                <h1 class="text-2xl font-semibold mt-5">ค้นหาผลิตภัณฑ์</h1>
            </div>

            <div class=" space-y-2 max-w-3xl mx-auto mt-5">
                <div class="w-full">
                    <select
            ...
            <div
                class=" mt-5 max-w-xl items-center mx-auto space-x-3 flex flex-col"
            >
                <div class="w-full">
